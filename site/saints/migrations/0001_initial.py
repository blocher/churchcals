# Generated by Django 4.2.21 on 2025-07-27 20:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("url", models.URLField(blank=True, max_length=2500, null=True)),
                (
                    "date_accessed",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to="podcast_images/"
                    ),
                ),
                ...
                (
                    "link",
                    models.URLField(
                        default="https://saints.benlocher.com", max_length=2500
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Name of the saint", max_length=2500),
                ),
                (
                    "canonization_status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title", models.CharField(max_length=2500)),
                ("url", models.URLField(blank=True, max_length=2500, null=True)),
                ("author", models.CharField(blank=True, max_length=2500, null=True)),
                (
                    "type",
                    models.CharField(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Episode number within the podcast",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("title", models.CharField(max_length=2500)),
                ("author", models.CharField(blank=True, max_length=2500, null=True)),
                ("date", models.CharField(blank=True, max_length=2500, null=True)),
                ("order", models.PositiveIntegerField(default=0)),
                (
                    "biography",
                    models.ForeignKey(
